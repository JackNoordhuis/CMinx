...
function({function_name} {params[0]} {params[1]})
        ...
        self.assertEqual(self.aggregator.documented[0].get_joined_doc().strip(), docstring, "Incorrect docstring extracted")
...
endmacro()
    ...
    def test_cpp_class_multi_superclass_multi_members(self,
        ...
        self.assertEqual(self.aggregator.documented[0].get_joined_doc().strip(), class_docstring, "Incorrect docstring extracted")
